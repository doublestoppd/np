...
export const tarnreachEvents: RandomEventDefinition[] = [
  ...
  },
  {
    ...
    message:
      "Something pale is wedged between two rocks at the edge, put there by weather rather than by anyone. It has clearly been there a while and is clearly not a stone.",
    weight: 90,
    enabled: true,
    category: "discovery",
    rarity: "uncommon",
